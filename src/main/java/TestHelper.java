...
public class TestHelper {
    ...
    public static void selectInDropdownByIndex(String locator, int number) {
        ...
        WebElement select = TestHelper.waitElementByXpath(locator);
    ...
    public static boolean isElementExist(String locator) {
        if (TestHelper.driver.findElement(By.xpath(locator)).isDisplayed() &&
                TestHelper.driver.findElement(By.xpath(locator)).isEnabled()) {
            return true;
        } else {
            return false;
        }
